...
for(j in 1:length(letters)){
  ...
  webpage[j] <- paste0("http://ufcstats.com/statistics/fighters?char=", letters[j], "&page=all")
...
write.csv(data_clean,"C:/users/pauly/downloads/official_fighter_data.csv", row.names = FALSE)